...
with order_part as (
    select * from {{ ref('silver_order_part_bx') }}
),
...
Entete as (
    SELECT
       ...
       ,'Jade Bordeaux'                                                                             AS cdce_module_origine
...
Lignes as (
    SELECT 
       ...
       ,'Jade Bordeaux'                                                                                 AS cdcl_module_origine
...
silver_sales_order_part as (
    ...
    /* =====================================================
       ...
       ===================================================== */
        ...
        'silver_order_part_sales_bx'                                 AS dbt_model_name,
